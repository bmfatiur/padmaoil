...
<div class="row">
    ...
    <div class="col-12">
        <div class="d-flex justify-content-start">
            <a href="{{ route('token.index') }}" class="btn btn-primary">
            ...
            <div class="card-body">
                <form action="{{ route('token.store') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" min="0" name="token_amount" class="form-control @error('token_amount')
                            is-invalid
                        @enderror" placeholder="enter token amount" id="">
                        @error('token_amount')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
